...
const addTwo = (arr) => {
  // Solution code here...
  let newArr = arr.map((plus) => plus + 2);
  return newArr;
};
...
const typeNum = (arr) => {
  // Solution code here...
  let numberOnly = arr.filter(num => typeof num === 'number');
  return numberOnly;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  let andThis = arr.filter(teslaSucks => teslaSucks.includes('and'));
  return andThis;
};
...
const oddValues = (arr) => {
  // Solution code here...
  let tooOdd = arr.filter(num => num%2);
  return tooOdd;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let wutAmIdoing = arr.filter(num => !forbiddenValues.includes(num));
  return wutAmIdoing;
};
